...
// clase para mandar el modelo directamente a la tabla
// esto con la llamada ResultSetTableModel modelo = new ResultSetTableModel(
//                "com.mysql.cj.jdbc.Driver",  // Driver de la base de datos
//                "jdbc:mysql://localhost:3306/mi_base_de_datos",  // URL de la base de datos
//                "SELECT * FROM alumnos"  // Consulta SQL
//            );
/*
y un try catch (SQLException | ClassNotFoundException e) {
            e.printStackTrace();
        }
 */
...
public class ResultSetTableModel extends AbstractTableModel {
    ...
    public ResultSetTableModel( String controlador, String url, String consulta ) throws SQLException, ClassNotFoundException
    {
        ...
        conexion = DriverManager.getConnection( url,"root","f44WOs%NvF" );
